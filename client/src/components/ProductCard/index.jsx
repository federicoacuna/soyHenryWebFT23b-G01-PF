...
export default function ProductCard ({ product, shouldDisplay, setState, state }) {
  ...
  return (
    <Box _hover={{ boxShadow: 'xl', transform: 'scale(1.010)', transition: 'ease 0.25s' }} transition='ease 0.25s' p='1rem' m='1rem' minHeight='325px' width='225px' boxShadow='md' display='flex' flexDirection='column' justifyContent='space-between' alignItems='center'>
