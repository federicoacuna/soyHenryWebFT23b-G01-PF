...
import { IoMdArrowRoundBack } from 'react-icons/io'//eslint-disable-line
import { getUserAddresses } from '../../redux/actions/addresses.actions'
import AddressContainer from '../../components/AddressContainer'//eslint-disable-line
import BranchContainer from '../../components/BranchContainer'

const AddressSelector = () => {
  const userAddresses = useSelector(state => state.addresses)//eslint-disable-line
  ...
  const handleClick = (value) => {//eslint-disable-line
  ...
  return (
    ...
    <Flex flexDirection='column' justifyContent='center' alignItems='center'>
      <Breadcrumb mt='1rem' p='0rem 0rem 0rem 2rem' w='61.3rem' spacing='8px' separator='<'>
        ...
        <BreadcrumbItem>
          <BreadcrumbLink><Link to='#'>Direcciones</Link></BreadcrumbLink>
        </BreadcrumbItem>
        {selectedAddress && <BreadcrumbItem>
          <BreadcrumbLink><Link to='/payment'>Pago</Link></BreadcrumbLink>
      ...
      <Flex mb='2rem' ml='5.3rem' mr='5.3rem' w='61.3rem' justifyContent='space-between'>
        ...
        <Flex p='2rem 2rem 0rem 2rem' flexDirection='column' w='30rem'>
          ...
          <Flex flexDirection='column'>
            ...
            {Array.isArray(userAddresses) && radioValue === '1'
              ? <Flex flexDirection='column'>
